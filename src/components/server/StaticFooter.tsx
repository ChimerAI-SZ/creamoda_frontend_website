          ...
          <div className="footer-ai-features">
            ...
            <div className="footer-features">
              ...
              <div className="feature-group">
                ...
                <a href="https://creamoda.ai/fashion-design/create" className="feature-item">Change Pose</a>
              </div>
              ...
              <div className="feature-group">
                ...
                <a href="https://creamoda.ai/fashion-design/create" className="feature-item">Pattern Extraction</a>
                <a href="https://creamoda.ai/fashion-design/create" className="feature-item">Pattern Application</a>
              </div>
            </div>
          </div>
